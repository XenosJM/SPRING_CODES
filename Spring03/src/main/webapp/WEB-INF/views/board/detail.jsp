...
<body>
   ...
   <input type="hidden" id="boardId" value="2">
      ...
      $(document).ready(function(){
         ...
         $('#btnAdd').click(function(){
            ...
            $.ajax({
               ...
               url : '../reply', // url
               headers : { // 헤더 정보
                  'Content-Type' : 'application/json' // json content-type 설정, 이게 안들어가면 405 페이지가 뜸
               }, 
               data : JSON.stringify(obj), // JSON으로 변환
               success : function(result) { // 전송 성공 시 서버에서 result 값 전송, jsp로 데이터를 가져올때는 java로 쓰지않으면 가져올수 없음
                  console.log(result);
                  if(result == 1) {
                     alert('댓글 입력 성공');
                     getAllReply(); // 함수 호출      
